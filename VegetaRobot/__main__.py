...
PM_START_TEXT = """
──「 [{}](https://telegra.ph/file/3826249c04b05d85952e9.jpg) 」──
*Hoho! {},*
*I am Pokémon Themed Advance Group Management Bot With A Lot Of Powerful Features.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
• *Uptime:* `{}`
• `{}` *users, across* `{}` *chats.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
...
If you want to report bugs or have any questions on how to use me then feel free to reach out: @hgbotsupportgroup.
All commands can be used with the following: [(/),(!),(?),(.),(~)](https://telegra.ph/file/0e680cd266a1c05f4eef2.jpg)
...
HELP_IMG= "https://telegra.ph/file/cea0d5455433770ffad12.jpg"
GROUPSTART_IMG= "https://telegra.ph/file/8cf4ecfe1848d6ecd92bd.jpg"
...
def main () :
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@hgbotsupportgroup","[Back Online⚡ ](https://telegra.ph/file/aeefd9933fe00b5cda60d.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
