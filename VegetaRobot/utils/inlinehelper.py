...
from VegetaRobot import OWNER_ID, pbot, arq
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("Get More Help.", url=f"t.me/HG_PIKACHU_BOT?start=start"),
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/3c5b70e4b9da656d2c188.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/HG_PIKACHU_BOT"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )
...
**Profiles:** [BOT](t.me/HG_PIKACHU_BOT) | [OWNER](https://github.com/hemanth233739)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/d9fa193f2ed927ec4e00f.jpg",
